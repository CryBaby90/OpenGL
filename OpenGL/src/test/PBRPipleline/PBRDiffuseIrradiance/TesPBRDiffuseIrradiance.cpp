...
void test::TesPBRDiffuseIrradiance::OnProcessMouseMovement(GLfloat xoffset, GLfloat yoffset)
{
	m_Camera->OnProcessMouseMovement(xoffset, yoffset);
}

void test::TesPBRDiffuseIrradiance::OnProcessInput(GLFWwindow* window, GLfloat deltaTime)
{
	m_Camera->OnProcessInput(window, deltaTime);
}

int test::TesPBRDiffuseIrradiance::LoadImage(char const* filename)
{
...
int test::TesPBRDiffuseIrradiance::LoadImage(char const* filename, bool gammaCorrection)
{
	unsigned int textureID;
	GLCall(glGenTextures(1, &textureID));
...
int test::TesPBRDiffuseIrradiance::LoadHdrImage(char const* filename)
{
...
void test::TesPBRDiffuseIrradiance::RenderQuad()
{
	if (m_QuadVAO == 0)
	{
		float quadVertices[] = {
...
void test::TesPBRDiffuseIrradiance::RenderCube()
{
	if (m_CubeVAO == 0)
	{
		float vertices[] = {
...
void test::TesPBRDiffuseIrradiance::RenderSphere()
{
	if (m_SphereVAO == 0)
	{
...
void test::TesPBRDiffuseIrradiance::OnUpdate(float deltaTime)
{
	
}

void test::TesPBRDiffuseIrradiance::OnRender()
{
...
void test::TesPBRDiffuseIrradiance::OnImGuiRender()
{
