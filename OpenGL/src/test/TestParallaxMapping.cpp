...
test::TestParallaxMapping::TestParallaxMapping()
...
void test::TestParallaxMapping::OnProcessMouseMovement(GLfloat xoffset, GLfloat yoffset)
{
	m_Camera->OnProcessMouseMovement(xoffset, yoffset);
}

void test::TestParallaxMapping::OnProcessInput(GLFWwindow* window, GLfloat deltaTime)
{
...
int test::TestParallaxMapping::LoadImage(char const* filename)
{
...
int test::TestParallaxMapping::LoadImage(char const* filename, bool gammaCorrection)
{
	unsigned int textureID;
	GLCall(glGenTextures(1, &textureID));
...
void test::TestParallaxMapping::RenderQuad()
{
	if (m_QuadVAO == 0)
	{
		// positions
...
void test::TestParallaxMapping::OnUpdate(float deltaTime)
{
	
}

void test::TestParallaxMapping::OnRender()
{
	...
	GLCall(glBindTexture(GL_TEXTURE_2D, m_HeightMap));
	RenderQuad();
...
void test::TestParallaxMapping::OnImGuiRender()
{
